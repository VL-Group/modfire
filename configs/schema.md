...
- [2. ![Required](https://img.shields.io/badge/Required-blue) Property `model`](#model)
  ...
  - [2.2. ![Optional](https://img.shields.io/badge/Optional-yellow) Property `params`](#model_params)
    - [2.2.1. Property `None`](#model_params_additionalProperties)
- [3. ![Required](https://img.shields.io/badge/Required-blue) Property `train`](#train)
  - [3.1. ![Required](https://img.shields.io/badge/Required-blue) Property `criterion`](#train_criterion)
    - [3.1.1. ![Required](https://img.shields.io/badge/Required-blue) Property `key`](#train_criterion_key)
    - [3.1.2. ![Optional](https://img.shields.io/badge/Optional-yellow) Property `params`](#train_criterion_params)
      - [3.1.2.1. Property `None`](#train_criterion_params_additionalProperties)
  - [3.2. ![Required](https://img.shields.io/badge/Required-blue) Property `database`](#train_database)
    ...
    - [3.2.2. ![Optional](https://img.shields.io/badge/Optional-yellow) Property `params`](#train_database_params)
      - [3.2.2.1. Property `None`](#train_database_params_additionalProperties)
  ...
  - [3.5. ![Optional](https://img.shields.io/badge/Optional-yellow) Property `externalLib`](#train_externalLib)
    - [3.5.1. None](#autogenerated_heading_2)
  ...
  - [3.7. ![Optional](https://img.shields.io/badge/Optional-yellow) Property `hooks`](#train_hooks)
    - [3.7.1. None](#autogenerated_heading_3)
...
| Property                                  | Pattern | Type   | Deprecated | Definition | Title/Description |
| ----------------------------------------- | ------- | ------ | ---------- | ---------- | ----------------- |
| - [](#model_params_additionalProperties ) | No      | object | No         | -          | -                 |

#### <a name="model_params_additionalProperties"></a>2.2.1. Property `None`
...
| Property                             | Pattern | Type                    | Deprecated | Definition                             | Title/Description                                                                                                                                                                                   |
| ------------------------------------ | ------- | ----------------------- | ---------- | -------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| + [criterion](#train_criterion )     | No      | object                  | No         | In #/definitions/GeneralSchema         | Loss function used for training.                                                                                                                                                                    |
...
| + [optim](#train_optim )             | No      | object                  | No         | Same as [criterion](#train_criterion ) | Optimizer used for training. As for current we have \`Adam\` and \`Lamb\`.                                                                                                                          |
...
| + [schdr](#train_schdr )             | No      | object                  | No         | Same as [criterion](#train_criterion ) | Learning rate scheduler used for training. As for current we have \`ReduceLROnPlateau\`, \`Exponential\`, \`MultiStep\`, \`OneCycle\` and all schedulers defined in \`modfire.train.lrSchedulers\`. |
...
| Property                             | Pattern | Type   | Deprecated | Definition | Title/Description |
| ------------------------------------ | ------- | ------ | ---------- | ---------- | ----------------- |
| + [key](#train_criterion_key )       | No      | string | No         | -          | key               |
| - [params](#train_criterion_params ) | No      | object | No         | -          | params            |

#### <a name="train_criterion_key"></a>3.1.1. ![Required](https://img.shields.io/badge/Required-blue) Property `key`
...
#### <a name="train_criterion_params"></a>3.1.2. ![Optional](https://img.shields.io/badge/Optional-yellow) Property `params`
...
| ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Type**                  | `object`                                                                                                                                                                            |
| **Additional properties** | [![Should-conform](https://img.shields.io/badge/Should-conform-blue)](#train_criterion_params_additionalProperties "Each additional property must conform to the following schema") |
| **Default**               | `{}`                                                                                                                                                                                |
...
| Property                                            | Pattern | Type   | Deprecated | Definition | Title/Description |
| --------------------------------------------------- | ------- | ------ | ---------- | ---------- | ----------------- |
| - [](#train_criterion_params_additionalProperties ) | No      | object | No         | -          | -                 |

##### <a name="train_criterion_params_additionalProperties"></a>3.1.2.1. Property `None`
...
| - [pipeline](#train_database_pipeline ) | No      | object | No         | Same as [criterion](#train_criterion ) | A spec of data loading pipeline. |
...
| Property                                           | Pattern | Type   | Deprecated | Definition | Title/Description |
| -------------------------------------------------- | ------- | ------ | ---------- | ---------- | ----------------- |
| - [](#train_database_params_additionalProperties ) | No      | object | No         | -          | -                 |

##### <a name="train_database_params_additionalProperties"></a>3.2.2.1. Property `None`
...
| **Type**                  | `object`                                                                                                 |
| **Additional properties** | [![Not allowed](https://img.shields.io/badge/Not%20allowed-red)](# "Additional Properties not allowed.") |
| **Same definition as**    | [criterion](#train_criterion)                                                                            |
...
#### <a name="autogenerated_heading_2"></a>3.5.1. None
...
#### <a name="autogenerated_heading_3"></a>3.7.1. None
