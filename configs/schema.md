...
- [2. ![Required](https://img.shields.io/badge/Required-blue) Property `train`](#train)
  - [2.1. ![Required](https://img.shields.io/badge/Required-blue) Property `ckptPath`](#train_ckptPath)
  - [2.2. ![Required](https://img.shields.io/badge/Required-blue) Property `criterion`](#train_criterion)
  - [2.3. ![Required](https://img.shields.io/badge/Required-blue) Property `database`](#train_database)
  ...
  - [2.14. ![Required](https://img.shields.io/badge/Required-blue) Property `valFreq`](#train_valFreq)
...
| Property                             | Pattern | Type                    | Deprecated | Definition                 | Title/Description                                                                                                                                                                                   |
| ------------------------------------ | ------- | ----------------------- | ---------- | -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| + [ckptPath](#train_ckptPath )       | No      | string                  | No         | -                          | ckptPath                                                                                                                                                                                            |
...
### <a name="train_ckptPath"></a>2.1. ![Required](https://img.shields.io/badge/Required-blue) Property `ckptPath`
...
**Description:** Path to restore model ckpt for warm training.

### <a name="train_criterion"></a>2.2. ![Required](https://img.shields.io/badge/Required-blue) Property `criterion`
...
### <a name="train_database"></a>2.3. ![Required](https://img.shields.io/badge/Required-blue) Property `database`
...
### <a name="train_valFreq"></a>2.14. ![Required](https://img.shields.io/badge/Required-blue) Property `valFreq`
